...
- ElixirSense: Fix autocomplete for many_to_many associations (thanks [Damon Janis](https://github.com/damonvjanis)) [elixir_sense [#120](https://github.com/elixir-lsp/vscode-elixir-ls/issues/120)](https://github.com/elixir-lsp/elixir_sense/pull/120)
...
- Drop OTP 20 and Elixir 1.7.x support and set some version support guidelines (thanks [Jason Axelson](https://github.com/axelson)) [PR [#337](https://github.com/elixir-lsp/vscode-elixir-ls/issues/337)](https://github.com/elixir-lsp/elixir-ls/pull/337)
...
- Bump ElixirSense
  ...
  - Adds erlang edoc support [elixir_sense [#86](https://github.com/elixir-lsp/vscode-elixir-ls/issues/86)](https://github.com/elixir-lsp/elixir_sense/pull/86)
...
VSCode:
- Change: No longer override default value of `editor.acceptSuggestionOnEnter` [vscode-elixir-ls [#53](https://github.com/elixir-lsp/vscode-elixir-ls/issues/53)](https://github.com/elixir-lsp/vscode-elixir-ls/pull/53)
- Change: Warn when incompatible extensions are installed [vscode-elixir-ls [#57](https://github.com/elixir-lsp/vscode-elixir-ls/issues/57)](https://github.com/elixir-lsp/vscode-elixir-ls/pull/57)

### v0.3.1: 3 Mar 2020

Improvements:

- Do not highlight function calls the same as function definitions [vscode-elixir-ls [#40](https://github.com/elixir-lsp/vscode-elixir-ls/issues/40)](https://github.com/elixir-lsp/vscode-elixir-ls/pull/40) (thanks [Jason Axelson](https://github.com/axelson))
...
- Add syntax rules for function calls [vscode-elixir-ls [#15](https://github.com/elixir-lsp/vscode-elixir-ls/issues/15)](https://github.com/elixir-lsp/vscode-elixir-ls/pull/15) (thanks [CaiqueMitsuoka](https://github.com/CaiqueMitsuoka))
